...
typedef ap_int<21> var;
typedef ushort bscore;
typedef char cost;
typedef int length;
typedef char clength;
typedef ap_uint<20> ucbidx;
...
#define UCBSIZE 500000 // multiple of 16
#define MAXK 16 // 64 // multiple of 16
#define MAXR 352 // 640 // multiple of 16
#define MAXNCLS 4000000 // multiple of 16
#define MAXNVAR 1000000 // multiple of 16
